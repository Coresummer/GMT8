...
void miller_proj_precomp_Costello(efp_t *S,efp2_t *R){  //S=P, R=Q
...
void ff_lttp_Costello(fp8_t *f, efp2_jacobian_t *U, efp_t *S){
  ...
  // fp2_set(&tmpD_fp2, &tmpC_fp2);    //D = aC //fp2_mul_base
...
//   fp2_mul_base_inv(&tmp1_fp8.x0.x1, &tmp1_fp8.x0.x1);   //necessary?
// //------------------------------------
//   fp2_set(&tmp1_fp8.x1.x0,&tmpJ_fp2);//J
// //------------------------------------

// //------------------------------------
//   fp_sub(&tmp1_fp2.x0, &miller_precomp_X2.x0,&miller_precomp_xS);
//   fp_set(&tmp1_fp2.x1,&miller_precomp_X2.x1);
//   fp2_mul(&tmp1_fp8.x0.x0,&tmp1_fp2,&tmpI_fp2);
//   fp2_mul_base(&tmp1_fp8.x0.x0,&tmp1_fp8.x0.x0);
//   fp2_mul_base(&tmp1_fp8.x0.x0,&tmp1_fp8.x0.x0);
// //------------------------------------
//   fp2_mul(&tmp1_fp8.x0.x1,&tmpJ_fp2,&miller_precomp_Y2);      //JY2
//   fp2_set_neg(&tmp1_fp8.x0.x1,&tmp1_fp8.x0.x1);
//   fp2_mul_base(&tmp1_fp8.x0.x1, &tmp1_fp8.x0.x1);   //necessary?
//   fp2_mul_base(&tmp1_fp8.x0.x1, &tmp1_fp8.x0.x1);   //necessary?
// //------------------------------------
//   fp2_mul_base(&tmp1_fp8.x1.x0,&tmpJ_fp2);//J
//   fp2_mul_base(&tmp1_fp8.x1.x0,&tmp1_fp8.x1.x0);//J
// //------------------------------------
