...
CXX = clang++-12
PROGRAM = CP8
OBJS   =  main.o create.o mcl.o scalar.o mpn.o fp.o fp2.o field_test.o time.o fp4.o fp8.o efp.o efp2.o efp4.o efp8.o test_efp.o  #miller.o final_exp.o test_pairing.o 
